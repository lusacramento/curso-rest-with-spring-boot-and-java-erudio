...
class PersonControllerV1XmlTest extends AbstractIntegrationTest {
...
//        SET USER
        ...
        personToBeAltered.setProfileUrl("https://profile.url/claudio_santoro");
        personToBeAltered.setPhotoUrl("https://photo.url/claudio_santoro.jpg");
    ...
    void findAllTest() throws JsonProcessingException {
        ...
        var content = given(specification)
                .accept(MediaType.APPLICATION_XML_VALUE)
                .queryParams("page", 4, "size", 10, "direction", "asc")
                .when()
                .get()
                .then()
                .	statusCode(200)
        ...
        assertEquals("Alonso", personOne.getFirstName());
        assertEquals("Luchelli", personOne.getLastName());
        assertEquals("9 Doe Crossing Avenue", personOne.getAddress());
        ...
        assertEquals("Alwin", personFour.getFirstName());
        assertEquals("Flockhart", personFour.getLastName());
        assertEquals("81 Forest Run Alley", personFour.getAddress());
    ...
    void findByNameTest() throws JsonProcessingException {
        ...
        assertEquals("Miranda", personOne.getFirstName());
        assertEquals("Widdowes", personOne.getLastName());
        assertEquals("6 Onsgard Alley", personOne.getAddress());
        ...
        assertEquals("Sande", personFour.getFirstName());
        assertEquals("Santon", personFour.getLastName());
        assertEquals("79318 Schlimgen Crossing", personFour.getAddress());
