...
public class AuthService {
    ...
    public ResponseEntity<TokenDTO> refreshToken(String username, String refreshToken) throws Exception {
    ...
    private User setNewUser(AccountCredentialsDTO user) {
